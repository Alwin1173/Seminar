...
\input{chapter/introduction}     % Includes the Introduction chapter
\input{chapter/literature survey}  % Includes the Literature Survey chapter
\input{chapter/comparison}      % Includes the Comparison chapter
\input{chapter/conclusion}      % Includes the Conclusion chapter
